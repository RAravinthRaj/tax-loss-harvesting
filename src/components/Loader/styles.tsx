...
export const LottieLoader = styled(Lottie)<{ $useModalLoader: boolean }>`
  width: ${(props) => (props?.$useModalLoader ? "100px" : "100px")};
  height: ${(props) => (props?.$useModalLoader ? "100px" : "100px")};

  @media (max-width: 576px) {
    width: ${(props) => (props?.$useModalLoader ? "100px" : "120px")};
    height: ${(props) => (props?.$useModalLoader ? "100px" : "120px")};
  }
`;
